...
public class CustomChunkGenerator extends InternalChunkGenerator
{
	...
	public net.minecraft.world.chunk.Chunk provideChunk(int x, int z)
	{
		...
		short[][] xbtypes = generator.generateExtBlockSections(((IMixinWorld) this.world).getWorld(), this.random, x, z, biomegrid);
		if(xbtypes != null)
		{
		...
		{ // Else check for byte-per-block section data
			byte[][] btypes = generator.generateBlockSections(((IMixinWorld) this.world).getWorld(), this.random, x, z, biomegrid);
			...
			{ // Else, fall back to pre 1.2 method
				...
				byte[] types = generator.generate(((IMixinWorld) this.world).getWorld(), this.random, x, z);
	...
	private static net.minecraft.world.chunk.storage.ExtendedBlockStorage newExtendedBlockStorage(int y, boolean flag, byte[] blkIds, byte[] extBlkIds)
	{
		net.minecraft.world.chunk.storage.ExtendedBlockStorage ebs = new net.minecraft.world.chunk.storage.ExtendedBlockStorage(y, flag);
