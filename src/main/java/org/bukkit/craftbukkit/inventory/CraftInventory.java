...
public class CraftInventory implements Inventory
{
	...
	{
		if (this.inventory instanceof IInventoryTransactionProvider)
...
//		} else if (inventory instanceof net.minecraft.inventory.ContainerEnchantTableInventory) { // TODO
...
//		} else if (inventory instanceof net.minecraft.inventory.ContainerRepairInventory) { // TODO
...
//        inventory.setMaxStackSize(size); // TODO
	...
	{
		return obj instanceof CraftInventory && ((CraftInventory) obj).getInventory().equals(this.getInventory());
	}
}
