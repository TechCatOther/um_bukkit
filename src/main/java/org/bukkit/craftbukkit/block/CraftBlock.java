...
public class CraftBlock implements Block
{
	...
	public int getBlockPower(BlockFace face)
	{
		...
		if((face == BlockFace.DOWN || face == BlockFace.SELF) && world.getIndirectPowerOutput(x, y - 1, z, 0)) power = func_150178_a(world, x, y - 1, z, power);
		if((face == BlockFace.UP || face == BlockFace.SELF) && world.getIndirectPowerOutput(x, y + 1, z, 1)) power = func_150178_a(world, x, y + 1, z, power);
		if((face == BlockFace.EAST || face == BlockFace.SELF) && world.getIndirectPowerOutput(x + 1, y, z, 2)) power = func_150178_a(world, x + 1, y, z, power);
		if((face == BlockFace.WEST || face == BlockFace.SELF) && world.getIndirectPowerOutput(x - 1, y, z, 3)) power = func_150178_a(world, x - 1, y, z, power);
		if((face == BlockFace.NORTH || face == BlockFace.SELF) && world.getIndirectPowerOutput(x, y, z - 1, 4)) power = func_150178_a(world, x, y, z - 1, power);
		if((face == BlockFace.SOUTH || face == BlockFace.SELF) && world.getIndirectPowerOutput(x, y, z + 1, 5)) power = func_150178_a(world, x, y, z - 1, power);
		return power > 0 ? power : (face == BlockFace.SELF ? isBlockIndirectlyPowered() : isBlockFaceIndirectlyPowered(face)) ? 15 : 0;
	}

	private static int func_150178_a(net.minecraft.world.World p_150178_1_, int p_150178_2_, int p_150178_3_, int p_150178_4_, int p_150178_5_)
	{
	...
	{ // Cauldron - initializer to initMappings() method; called in CraftServer
		...
		for(int i = 0; i < BIOME_MAPPING.length; i++)
		{
			if((BiomeGenBase.getBiome(i) != null) && (BIOME_MAPPING[i] == null))
			{
				...
				FMLLog.fine("Adding biome mapping " + BiomeGenBase.getBiome(i).biomeID + " " + name + " at BiomeBase[" + i + "]");
