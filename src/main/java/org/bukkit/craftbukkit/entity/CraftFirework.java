...
public class CraftFirework extends CraftEntity implements Firework
{
	...
	public void setFireworkMeta(FireworkMeta meta)
	{
		...
		((IMixinEntityFireworkRocket) getHandle()).setLifetime(10 * (1 + meta.getPower()) + random.nextInt(6) + random.nextInt(7));
	...
	{
		((IMixinEntityFireworkRocket) getHandle()).setLifetime(0);
	}
}
