...
public class CraftHorse extends CraftAnimals implements Horse
{
	...
	public void setCarryingChest(boolean chest)
	{
		...
		((IMixinEntityHorse) getHandle()).createChest();
	}
	...
	public void setMaxDomestication(int value)
	{
		...
		((IMixinEntityHorse) getHandle()).setMaxDomestication(value);
	}
	...
	public void setJumpStrength(double strength)
	{
		...
		getHandle().getEntityAttribute(((IMixinEntityHorse) getHandle()).getStaticHorseJumpStrength()).setBaseValue(strength);
	}
	...
	{
		return new CraftInventoryHorse(((IMixinEntityHorse) getHandle()).getHorseChest());
	}
