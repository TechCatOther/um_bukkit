...
public abstract class CraftEntity implements org.bukkit.entity.Entity
{
	...
	public static CraftEntity getEntity(CraftServer server, net.minecraft.entity.Entity entity)
	{
		...
		else if(entity instanceof net.minecraft.entity.projectile.EntityThrowable)
		{
			...
			{
				return new CraftProjectile(server, (net.minecraft.entity.projectile.EntityThrowable) entity);
			} // Cauldron
		}
	...
	{
		for(Map.Entry<Class<? extends Entity>, String> entry : ((IMixinEntityRegistry) EntityRegistry.instance()).getEntityTypeMap().entrySet())
		{
	...
	public boolean isOnGround()
	{
		...
		{
			return ((IMixinEntityArrow) entity).isInGround();
		}
	...
	public World getWorld()
	{
		...
		if(((IMixinWorld) entity.worldObj).getWorld() == null)
		{
			return ((IMixinWorld) DimensionManager.getWorld(0)).getWorld();
		}
		// Cauldron end
		return ((IMixinWorld) entity.worldObj).getWorld();
	}
	...
	public boolean teleport(Location location, TeleportCause cause)
	{
		...
		{
			((IMixinEntity) entity).teleportTo(location, cause.isPortal());
			return true;
		}
		// Spigot
	...
	{
		return ((IMixinEntity) entity).getFireTicks();
	}
	...
	{
		((IMixinEntity) entity).setFireTicks(ticks);
	}
	...
	{
		return isEmpty() ? null : ((IMixinEntity) getHandle().riddenByEntity).getBukkitEntity();
	}
	...
	public boolean setPassenger(org.bukkit.entity.Entity passenger)
	{
		...
		{
			((IMixinEntity) ((CraftEntity) passenger).getHandle()).setPassengerOf(getHandle());
			return true;
		}
		else
		{
	...
	public boolean eject()
	{
		...
		((IMixinEntity) getHandle().riddenByEntity).setPassengerOf(null);
		return true;
	}
	...
	public boolean leaveVehicle()
	{
		...
		((IMixinEntity) getHandle()).setPassengerOf(null);
		return true;
	}
	...
	public org.bukkit.entity.Entity getVehicle()
	{
		...
		return ((IMixinEntity) getHandle().ridingEntity).getBukkitEntity();
	}
