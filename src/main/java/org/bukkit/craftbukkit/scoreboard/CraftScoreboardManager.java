...
public final class CraftScoreboardManager implements ScoreboardManager
{
	...
	{
		if(Thread.currentThread() != net.minecraft.server.MinecraftServer.getServer().getServerThread()) throw new IllegalStateException("Asynchronous scoreboard creation"); // Spigot
	...
	public void setPlayerBoard(CraftPlayer player, org.bukkit.scoreboard.Scoreboard bukkitScoreboard) throws IllegalArgumentException
	{
		...
		((IMixinServerConfigurationManager) server.getConfigurationManager()).sendScoreboard((net.minecraft.scoreboard.ServerScoreboard) newboard, player.getHandle());
	}
