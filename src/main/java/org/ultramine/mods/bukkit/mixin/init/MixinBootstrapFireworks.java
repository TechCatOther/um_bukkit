...
public class MixinBootstrapFireworks
{
	/**
	...
	public ItemStack dispenseStack(IBlockSource blockSource, ItemStack itemStack)
	{
		...
		EntityFireworkRocket entityfireworkrocket = new EntityFireworkRocket(blockSource.getWorld(), event.getVelocity().getX(), event.getVelocity().getY(), event.getVelocity().getZ(), itemstack1);
